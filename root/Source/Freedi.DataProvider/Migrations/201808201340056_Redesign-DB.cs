namespace Freedi.DataProvider.Migrations
{
    ...
    public partial class RedesignDB : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Order", "ClientProfile_Id", "dbo.ClientProfiles");
            DropForeignKey("dbo.ClientProfiles", "Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.CartLines", "Order_Id", "dbo.Order");
            DropForeignKey("dbo.Photos", "GoodsId", "dbo.Goods");
            DropForeignKey("dbo.CartLines", "GoodsId", "dbo.Goods");
            DropForeignKey("dbo.Order", "ApplicationUserId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.CartLines", new[] { "Order_Id" });
            DropIndex("dbo.CartLines", new[] { "GoodsId" });
            DropIndex("dbo.Order", new[] { "ClientProfile_Id" });
