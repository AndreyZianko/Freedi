...
namespace Freedi.Website
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/bundles/AdminPanel").Include(
                "~/Content/AdminPanel/vendor/bootstrap/js/bootstrap.bundle.min.js"
                , "~/Content/AdminPanel/vendor/jquery-easing/jquery.easing.min.js",
                "~/Content/AdminPanel/vendor/datatables/jquery.dataTables.min.js",
                "~/Content/AdminPanel/vendor/datatables/dataTables.bootstrap4.min.js",
                "~/Scripts/AdminPanel/sb-admin.js"));
            bundles.Add(new ScriptBundle("~/bundles/bootstrap").Include("~/Scripts/bootstrap/popper.js",
                "~/Scripts/bootstrap/bootstrap.min.js", "~/Scripts/TemplatePlugins/OwlCarousel2-2.2.1/owl.carousel.js",
                "~/Scripts/TemplateScripts/custom.js"));
